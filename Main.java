...
class SnakeGame extends JPanel {
    ...
    private static Font FONT_M = new Font("SansSerif", Font.PLAIN, 24);
    private static Font FONT_M_ITALIC = new Font("SansSerif", Font.ITALIC, 24);
    private static Font FONT_L = new Font("SansSerif", Font.PLAIN, 84);
    private static Font FONT_XL = new Font("SansSerif", Font.PLAIN, 150);
    ...
    private void render(Graphics g) {
        ...
        g2d.drawRect(20, 40, WIDTH, HEIGHT); // Black border
    }
